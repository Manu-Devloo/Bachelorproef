...
CTFd is in de basis gericht op het beheren van de wedstrijdlogica en bevat geen ingebouwde orkestratie voor het per gebruiker/team opstarten van service-instanties~\autocite{CTFdGitHub,CTFd}. Voor dynamische deployments bestaan er community-plugins, zoals CTFd-Whale~\autocite{CTFdWhale}, die proberen containerbeheer te integreren in het platform.
