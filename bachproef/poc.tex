...
% TODO: CTFd en plugin op een eerste VM plaatsen en runtime-containers op een tweede VM starten
% TODO: valideren of cleanup ook betrouwbaar blijft wanneer de Docker-host tijdelijk onbereikbaar is
% TODO: onderzoeken of een extra orchestratorlaag nuttig blijft in een remote deployment zonder de plugin als hoofdinterface te verlaten
