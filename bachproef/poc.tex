...
\begin{figure}[htbp]
  ...
  \caption[Architectuur van de plugin-PoC]{Architectuur van de plugin-PoC op een enkele host. CTFd blijft het centrale platform, terwijl de plugin de lifecycle van challenge-containers en de bijhorende metadata beheert.}
